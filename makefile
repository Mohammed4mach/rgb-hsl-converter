...
link-hsl: build-hsl $(UTILS_OBJ)
	gcc $(BUILD_OPTIONS) $(UTILS_OBJ) $(OBJ)/$(HSL_NAME).o -o $(BIN)/$(HSL_NAME)
...
production: $(UTILS_OBJ)
	gcc $(BUILD_OPTIONS_PRODUCTION) -c $(SRC)/$(RGB_NAME).c -o $(OBJ)/$(RGB_NAME).o
	gcc $(BUILD_OPTIONS_PRODUCTION) -c $(SRC)/$(HSL_NAME).c -o $(OBJ)/$(HSL_NAME).o
	gcc $(BUILD_OPTIONS_PRODUCTION) $(UTILS_OBJ) $(OBJ)/$(RGB_NAME).o -o $(BIN)/$(RGB_NAME)
	gcc $(BUILD_OPTIONS_PRODUCTION) $(UTILS_OBJ) $(OBJ)/$(HSL_NAME).o -o $(BIN)/$(HSL_NAME)
